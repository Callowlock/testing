...
// Error class to deal with iterator
...
// sets the iterator to the next node, throws error if iterator is null
template <class T>
...
// sets the iterator to the previous node, throws error if iterator is null
template <class T>
